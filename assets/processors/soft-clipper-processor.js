/**
 * Thanks Paul Adenot, taken from Mozilla Hacks
	...
	process(input, output, parameters) {
        ...
        let sampleCount = input[portIndex][channelIndex].length;
				for (let sampleIndex = 0; sampleIndex < sampleCount; sampleIndex++) {
					...
					output[0][channelIndex][sampleIndex] = Math.tanh(
						amount * input[portIndex][channelIndex][sampleIndex]
					);
				}
			}
		}
...
registerProcessor("soft-clipper", SoftClipper);
